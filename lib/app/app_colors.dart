...
class AppColors {
  ...
  static const Color updateNotificationColorLight =
      Color(0xFF4CAF50); // Green color
  static const Color updateNotificationColorDark =
      Color(0xFF00796B); // Dark green color
  static const Color deleteNotificationColorLight =
      Color(0xFFE57373); // Red color
  static const Color deleteNotificationColorDark =
      Color(0xFFB71C1C); // Dark red color
}
